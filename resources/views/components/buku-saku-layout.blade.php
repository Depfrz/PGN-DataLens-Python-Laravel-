            ...
            <nav class="flex flex-col p-3 space-y-1">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="p-3 sm:p-4 text-gray-900">
                            ...
                            @if(session('error'))
                                <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)" class="mb-4 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative shadow-sm" role="alert">
                                    <div class="flex items-start">
                                        <div class="flex-shrink-0">
