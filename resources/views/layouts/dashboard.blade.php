...
<body class="font-sans antialiased bg-[#d9d9d9] dark:bg-gray-900 transition-colors duration-300">
    <div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden bg-[#d9d9d9] dark:bg-gray-900 transition-colors">
        ...
        <!-- Sidebar -->
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-30 w-[280px] bg-white/80 dark:bg-gray-900/70 backdrop-blur border-r border-gray-200/70 dark:border-gray-800 flex flex-col transition-transform duration-300 lg:static lg:translate-x-0">
            <!-- Logo -->
            <div class="p-6 flex items-center justify-center border-b border-gray-200/60 dark:border-gray-800/80">
            ...
            <nav class="flex-1 px-4 space-y-4 mt-4">
                <!-- Dashboard -->
                <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-3 rounded-xl transition-colors group {{ request()->routeIs('dashboard') ? 'bg-white/80 dark:bg-gray-800 shadow-sm ring-1 ring-gray-200/70 dark:ring-gray-700/60' : 'hover:bg-gray-100/80 dark:hover:bg-gray-800/70' }}">
                    <div class="w-8 h-8 flex items-center justify-center mr-4">
                        <!-- Home Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-gray-700 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-white transition-colors">
                            <path d="M11.47 3.84a.75.75 0 011.06 0l8.69 8.69a.75.75 0 101.06-1.06l-8.689-8.69a2.25 2.25 0 00-3.182 0l-8.69 8.69a.75.75 0 001.061 1.06l8.69-8.69z" />
                            <path d="M12 5.432l8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 01-.75-.75v-4.5a.75.75 0 00-.75-.75h-3a.75.75 0 00-.75.75V21a.75.75 0 01-.75.75H5.625a1.875 1.875 0 01-1.875-1.875v-6.198a2.29 2.29 0 00.091-.086L12 5.43z" />
                        </svg>
                    </div>
                    <span class="text-sm font-semibold text-gray-800 dark:text-gray-100 group-hover:text-gray-900 dark:group-hover:text-white transition-colors">Dashboard</span>
                </a>

                <!-- Data History -->
                @can('view module history')
                <a href="{{ route('history') }}" class="flex items-center px-4 py-3 rounded-xl transition-colors group {{ request()->routeIs('history') ? 'bg-white/80 dark:bg-gray-800 shadow-sm ring-1 ring-gray-200/70 dark:ring-gray-700/60' : 'hover:bg-gray-100/80 dark:hover:bg-gray-800/70' }}">
                    <div class="w-8 h-8 flex items-center justify-center mr-4">
                        <!-- History Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-gray-700 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-white transition-colors">
                    ...
                    <span class="text-sm font-semibold text-gray-800 dark:text-gray-100 group-hover:text-gray-900 dark:group-hover:text-white transition-colors">Data History</span>
                </a>
                @endcan

                <!-- Management User -->
                @can('view module management-user')
                <a href="{{ route('management-user.index') }}" class="flex items-center px-4 py-3 rounded-xl transition-colors group {{ request()->routeIs('management-user.*') ? 'bg-white/80 dark:bg-gray-800 shadow-sm ring-1 ring-gray-200/70 dark:ring-gray-700/60' : 'hover:bg-gray-100/80 dark:hover:bg-gray-800/70' }}">
                    <div class="w-8 h-8 flex items-center justify-center mr-4">
                        <!-- User Group Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-gray-700 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-white transition-colors">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <!-- Top Header -->
            <header class="bg-white/85 dark:bg-gray-900/80 backdrop-blur border-b border-gray-200/70 dark:border-gray-800 h-[72px] shadow-sm flex items-center justify-between px-4 lg:px-8 z-20 transition-colors duration-300">
                <div class="flex items-center">
                    <button @click="sidebarOpen = true" class="lg:hidden p-2 -ml-2 mr-1 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                    ...
                    <span class="text-sm font-semibold text-gray-900 dark:text-white tracking-tight ml-1">PGN One Portal</span>
                </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div x-data="{
                        ...
                        <button @click="toggleTheme()" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 transition-colors duration-200 border border-transparent dark:border-gray-700">
