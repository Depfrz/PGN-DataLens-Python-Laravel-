            ...
            @forelse($modules as $module)
                ...
                <a href="{{ $module->url }}" 
                   ...
                   class="group relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-xl border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:-translate-y-1 flex flex-col items-center text-center h-full overflow-hidden cursor-pointer">
                    ...
                    <div class="relative w-[100px] h-[100px] mb-6 rounded-2xl bg-gray-50 dark:bg-gray-700/50 flex items-center justify-center p-4 shadow-inner group-hover:scale-105 transition-transform duration-300 group-hover:bg-white dark:group-hover:bg-gray-700 z-10">
                        @if($previewUrl)
                            <img src="{{ $previewUrl }}" 
                                 alt="{{ $module->name }}" 
                                 loading="lazy"
                        ...
                        @else
                            <img src="{{ $placeholderDataUri }}" alt="Placeholder" loading="lazy" class="w-full h-full object-contain">
                        @endif
                    </div>

                    <!-- Content -->
                    <div class="relative z-10 w-full mb-4">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors line-clamp-1">
                            {{ $module->name }}
                        </h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400 line-clamp-2 leading-relaxed h-10 overflow-hidden">
                    ...
                    <div class="relative z-10 mt-auto w-full">
                        <span class="inline-flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-blue-600 bg-blue-50 rounded-lg group-hover:bg-blue-600 group-hover:text-white transition-all duration-300 dark:bg-blue-900/20 dark:text-blue-400 dark:group-hover:bg-blue-600 dark:group-hover:text-white">
                            Buka Sistem
